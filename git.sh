...
# `(menu)`, `(api)`).
#
# `<description>` - краткое описание по вышеизложенным правилам.

# body - тело коммита с более подробным описанием (но уже в свободной форме),
# которое может состоять из нескольких абзацев, разделённых новой строкой.

# footer - футер коммита, отделяемый от body новой строкой, который может
# состоять из нескольких абзацев, разделённых новой строкой.
#
