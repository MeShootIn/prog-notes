...
# TODO https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md#type
# Основные значения `<type>`:
# * `build` - изменения, влияющие на систему сборки или внешние зависимости
# (например: gulp, yarn, npm);
# * `chore`
